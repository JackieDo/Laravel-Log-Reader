...
class LogReaderGetCommand extends Command
{
    ...
    protected function getLogEntries()
    {
        if ($this->option('paginate')) {
            ...
            $this->line("You are viewing page ".$logs->getCurrentPage()."/".$logs->getLastPage()." as follow:\r\n");
        } else {
    ...
    protected function getOptions()
    {
        return array(
            ...
            array('page', null, InputOption::VALUE_OPTIONAL, 'The page that you want to display', 1),
        );
    }
