...
This documentation is use for Laravel 4.2. If you want to use on Laravel 5+, please read at [here](https://github.com/JackieDo/Laravel-Log-Reader/tree/version-2.x)
...
- The next step is add the follow line to the section `aliases` in file `app/config/app.php`:
...
You already know how to simply paging with the `paginate()` method. Now, you should know that the `paginate()` method has total three parameters as follow:
